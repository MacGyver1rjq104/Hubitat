...
metadata {
    ...
    preferences {
        // BEGIN:getDefaultMetadataPreferences(includeCSS=True)
        // Default Preferences
        ...
        // END:  getDefaultMetadataPreferences(includeCSS=True)
...
ArrayList<String> parse(String description) {
    ...
    logging("msgMap: ${msgMap} (hasStruct=$hasStruct)", 0)
